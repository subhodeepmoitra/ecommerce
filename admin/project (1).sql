...
--
-- Host: 127.0.0.1
-- Generation Time: Apr 18, 2022 at 02:00 PM
...
INSERT INTO `order` (`id`, `username`, `address`, `city`, `pincode`, `payment_type`, `total_price`, `payment_status`, `order_status`, `added_on`) VALUES
(1, 'test', 'test', 'test', 'test', 'test', 'test', 'test', 'test', '2022-04-01 05:26:44.000000');
...
(9, 2, 'Subhodeep Moitra', 50, 5, 1, '646246341_Screenshot (28).png', 'dev', 'dev', 'dev', '', 'dev', 1),
(10, 2, 'Debraj Dhang', 50, 10, 1, '835195929_Screenshot (4).png', 'tester', 'tester', 'tester', 'tester', 'tester', 1),
(11, 2, 'Kaustav Ghosh', 100, 10, 1, '622220552_Screenshot (6).png', 'test', 'test', 'tst', '', 'test', 1);
