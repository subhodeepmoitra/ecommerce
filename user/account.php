    ...
    <div class="navbar">
        ...
        <nav>
            <ul id="MenuItems">
                ...
                <li><a href="account.php" class="activee active">Account</a></li>
            </ul>
        </nav>
...
<div class="account-page">
    <div class="container">
        <div class="row">
            <div class="col-2">
                <img src="images/image02.png" alt="image" width="70%">
            </div>
            <div class="col-2">
                ...
                echo "<br><br><a href='logout.php'><input type='submit' value='Logout'><br></a> ";
                    ...
                    echo "<a href='login.php'><input type='submit' value='Login'><br></a> 
