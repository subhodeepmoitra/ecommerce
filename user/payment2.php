            ...
            <div class="card credit-card-box">
                ...
                <div class="card-body">
                    ...
                    <div class="col-12">
                        ...
                        <?php
          $price = $_GET['price'];
        $Record = mysqli_query($conn,"select product.*,categories.categories from product,categories where price='$price' LIMIT 1");
        //$row = $_GET['price'];
        while($price = mysqli_fetch_array($Record)){
          echo"<div class='col-12'><input type='submit' id='submit' class='btn btn-success btn-lg d-block w-100' name='upload' value='Pay &#8377; $price[price]' </div>";     
        }
        ?>
